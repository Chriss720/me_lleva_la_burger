...
export const Home = () => {
  ...
  return (
    <Layout>
      ...
      <section className="py-12 md:py-20 px-4 bg-black text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center w-full z-10 relative">
          <div className="text-center mb-8 md:mb-12 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl md:text-8xl uppercase text-[#FFC72C] leading-tight md:leading-none mb-6 font-oswald font-bold tracking-tighter drop-shadow-xl">
      ...
      {/* Productos */}
      <section className="py-12 md:py-20 px-4 md:px-12 bg-[#111] bg-center bg-cover bg-no-repeat" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.9), rgba(0,0,0,0.9)), url('/images/bg-texture.jpg')" }}>
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-8 md:mb-12 border-b border-gray-800 pb-6 gap-4">
            <h2 className="text-3xl md:text-5xl uppercase text-[#FFC72C] font-bold text-center md:text-left">Nuestro Menú</h2>
          ...
          {productsLoading ? (
            ...
            <>
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 lg:gap-12 xl:gap-14">
              ...
              {!showAllProducts && products.length > 6 && (
                <div className="flex justify-center mt-10 md:mt-16 mb-8 md:mb-12">
                  <button
                    onClick={() => setShowAllProducts(true)}
                    className="bg-[#FFC72C] text-black text-base md:text-lg px-8 md:px-10 py-3 md:py-4 rounded-full font-bold hover:bg-yellow-400 hover:scale-105 transition-all shadow-lg hover:shadow-yellow-500/20"
                  >
      ...
      {isAuthenticated && user && (
        <section className="py-12 md:py-20 px-4 md:px-12 bg-[#151515]">
          <div className="max-w-7xl mx-auto w-full">
            <h2 className="text-3xl md:text-4xl uppercase text-[#FFC72C] mb-8 md:mb-12 font-bold border-b border-gray-800 pb-6">Mis Compras</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
              {/* Carrito */}
              <div className="bg-[#1a1a1a] rounded-2xl p-6 md:p-8 border border-[#333] shadow-xl">
                <h3 className="text-xl md:text-2xl text-[#FFC72C] mb-6 flex items-center gap-3">
                ...
                {cartItems.length > 0 ? (
                  <>
                    ...
                    <div className="bg-[#222] rounded-xl p-4 md:p-6 mb-6">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300 text-lg">Total a pagar:</span>
                        <span className="text-[#FFC72C] font-bold text-2xl md:text-3xl">${getTotal().toFixed(2)}</span>
                      </div>
                    </div>
                    <button
                      onClick={async () => {
      ...
      {!isAuthenticated && (
        <section className="py-16 md:py-24 px-4 md:px-8">
          <div className="max-w-4xl mx-auto bg-[#1a1a1a] rounded-2xl p-8 md:p-16 text-center border border-[#FFC72C] shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-2 bg-[#FFC72C]"></div>
            <svg viewBox="0 0 24 24" className="w-16 h-16 md:w-24 md:h-24 fill-[#FFC72C] mx-auto mb-8 transform group-hover:scale-110 transition-transform duration-500">
              <path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z" />
            </svg>
            <h2 className="text-3xl md:text-5xl text-white mb-6 font-bold font-oswald uppercase tracking-tight">¿Listo para ordenar?</h2>
            ...
            <a
              href="/login"
              className="inline-block bg-[#FFC72C] text-black px-10 py-4 rounded-full font-bold text-lg md:text-xl hover:bg-yellow-400 hover:scale-105 transition-all shadow-lg hover:shadow-yellow-500/20"
            >
              Acceder Ahora
            </a>
          </div>
      ...
      {/* Sección Sobre Nosotros */}
      {/* Sección Sobre Nosotros */}
      <section className="py-16 md:py-24 px-4 md:px-8 relative overflow-hidden bg-fixed bg-center bg-cover" style={{ backgroundImage: "url('/images/bg-ingredients.png')" }}>
        <div className="absolute inset-0 bg-black/80"></div>
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-5xl uppercase text-[#FFC72C] mb-8 font-bold">Nuestra Historia</h2>
      ...
      {/* Testimonios */}
      {/* Testimonios */}
      <section className="py-16 md:py-24 px-4 md:px-12 bg-black bg-center bg-cover bg-no-repeat" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.9), rgba(0,0,0,0.9)), url('/images/bg-texture.jpg')" }}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-5xl uppercase text-[#FFC72C] mb-16 md:mb-24 font-bold text-center">Lo que Dicen Nuestros Clientes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mt-8">
            <div className="bg-[#1a1a1a] rounded-2xl p-8 md:p-10 border border-[#333] relative">
